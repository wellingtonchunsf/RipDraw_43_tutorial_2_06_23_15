# 
# makefile Version 3.0T 6/23/15 Tutorial Makefile;  Makefile for Beagle Bone Cross Compile on Windows
# 
...
# to switch from windows development to BBB native compiler tools, comment out the "SHELL = cm
SHELL = cmd
REMOVE = rm -f
